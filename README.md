...
- **Живі сповіщення по швидких цілях** — ракети, балістика, КАБи, МіГ-31К: окреме повідомлення, коли така ціль **наближається** до регіону і коли **входить** у нього. Подієво (поява / вхід), а не щотік — «ціль зсунулась на кілометр» навмисно не шлеться. Дрони/FPV/розвідники сюди не входять (їх покриває звичайна тривога й мапа), щоб дронова ніч не перетворилась на потік повідомлень. Набір типів і дистанцію можна змінити (`LIVE_ALERT_TYPES`, `LIVE_ALERT_KM`).
